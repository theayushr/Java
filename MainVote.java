...
class Vote{
	...
	void winner(){
		System.out.println("Candidate 1- Ayush: " + ayush);
		System.out.println("Candidate 2- Jatin: " + jatin);
		System.out.println("Candidate 3- Shraddha: " + shraddha);
		System.out.println("Candidate 4- Tanya: " + tanya);
		System.out.println("Candidate 5- Magnus: " + magnus);
	}
}
